...
If you encounter any problems, please do not hesitate to contact us via email or directly in GitHub. We will update this documentation with the occurring problems.
...
Ensure that your run-script contains `if __name__ == "__main__"`. If this is missing, it can crash the multiprocessing in a Windows environment.
