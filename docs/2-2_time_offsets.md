...
PROFFASTpylot allows processing measurements which have been recorded near the dateline, where one local day belongs to two different UTC days and vice versa.
