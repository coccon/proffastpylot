...
Technically this is solved by adding new parameter in the PREPROCESS input fille,
which allows to adapt the behaviour of the PREPROCESS to the instrument.
...
This option is only recommended to be used by exper-users. Therefore no templace for this case is given.
