...
for job_n in range(jobs):
  ...
  # subprocess.Popen(["xterm", "-e", "python37", "04_pcx-inv-input-files-and-process.py", str(jobs), str(job_n)], shell = True, cwd = main_path) # Linux
    time.sleep (5) # sleep 5 seconds

# a = subprocess.Popen(["xterm","-e","python37", "04_pcx-inv-input-files-and-process.py", str(jobs), str(job_n)], shell = True, cwd = main_path)
# a.wait()
