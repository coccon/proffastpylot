...
logical :: convergdec,sampdec,inverfolg
...
real :: dp,dT,sollnorm,nueskalfaktor,give_rms,damping,dpmean,LMstab,largest_EVal
...
write(zeile(56:63),'(1X,F7.2)') obs(ispec)%azimuth_deg
