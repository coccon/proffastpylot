...
integer,parameter :: mpowFFT = 17
integer,parameter :: maxifg = 2**mpowFFT
integer,parameter :: maxspc = maxifg / 2
integer,parameter :: maxspcrs = 56874
...
integer,parameter :: ifgradius = 56873 ! ifgradius equivalent to 1.8 cm OPDmax
...
integer :: nmeas,nmeasall,nloop,nloopoff,nsinc !nsinc: width of sinc kernel on oversampled fft grid -nsinc...+nsinc
